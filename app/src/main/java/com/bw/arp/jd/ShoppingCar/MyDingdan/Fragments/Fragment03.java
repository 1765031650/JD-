...
public class Fragment03 extends Fragment implements IDingdanListView {
    @BindView(R.id.rlv_f3)
    RecyclerView mRlvF3;
    ...
    public void onSuccess(DingdanListBean dingdanListBean) {
        ...
        mRlvF3.setLayoutManager(linearLayoutManager);
        mRlvF3.setAdapter(adapter);
    }
